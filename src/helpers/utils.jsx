...
export const sanitizeConfig = (config) => {
  ...
  return {
    ...
    social: {
      ...
      exercism: config?.social?.exercism,
      tryhackme: config?.social?.tryhackme,
      codewars: config?.social?.codewars,
    ...
    sideskills: config?.sideskills || [],
    legacyskills: config?.legacyskills || [],
